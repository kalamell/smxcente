	<div class='container-fluid'>
		<ol class="breadcrumb">
			  ...
			  <li class="active"> ตารางแสดงอัตราการรับนักเรียนระดับมัธยมศึกษาตอนต้น (Enrolment Rate) ในแต่ละสถานศึกษา </li>
			</ol>
		...
		<div class="row">
			...
			<div class='col-md-12'>
				<div class="panel panel-default">
				  <div class="panel-heading">ตารางแสดงอัตราการรับนักเรียนระดับมัธยมศึกษาตอนต้น (Enrolment Rate) ในแต่ละสถานศึกษา</div>
							...
							<table class="table table-bordered table-striped">
			                  <thead>
			                    <tr>
			                      ...
			                      <th width="120" colspan="3">วัยเรียน 13-15ปี</th>
			                      <th width="120" rowspan="2">Trans.</th>
			                      <th width="120" colspan="3">ม.1 - ม.3</th>
