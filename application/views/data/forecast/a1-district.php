	<div class='container-fluid'>
		<ol class="breadcrumb">
			  ...
			  <li class="active"> ตารางแสดงจำนวนเด็กเข้าเรียนอนุบาล 1 (Admission Rate) ในแต่ละตำบล </li>
			</ol>
		...
		<div class="row">
			...
			<div class='col-md-12'>
				<div class="panel panel-default">
				  <div class="panel-heading"> ตารางแสดงจำนวนเด็กเข้าเรียนอนุบาล 1 (Admission Rate) ในแต่ละตำบล </div>
			                    		...
			                    		<?php foreach ($district as $ds):?>
			                    			<?php if ($ds->AMPHUR_ID == $am->AMPHUR_ID):?>
			                    				<tr>
						                    		...
						                    		<td style="text-align: right">
						                    			<?php 
						                    			$num5 = getLevelA1District($ds->DISTRICT_ID, 'boy', 'spt');
						                    			echo $num5;
						                    			?>
						                    		</td>
						                    		<td style="text-align: right">
						                    			<?php 
						                    			$num6 = getLevelA1District($ds->DISTRICT_ID, 'girl', 'spt');
						                    			echo $num6;
						                    			?>
						                    		...
						                    		<td style="text-align: right">
						                    			<?php 
						                    			$num7 = getLevelA1District($ds->DISTRICT_ID, 'boy', 'oth');
						                    			echo $num7;
						                    			?>
						                    		</td>
						                    		<td style="text-align: right">
						                    			<?php 
						                    			$num8 = getLevelA1District($ds->DISTRICT_ID, 'girl', 'oth');
						                    			echo $num8;
						                    			?>
