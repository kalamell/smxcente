	<div class='container-fluid'>
		<ol class="breadcrumb">
			  ...
			  <li class="active"> ตารางแสดงจำนวนเด็กเข้าเรียนอนุบาล 2 สู่ อนุบาล 3 (Admission Rate) ในแต่ละสถานศึกษา </li>
			</ol>
			                    				...
			                    				<tr style="background-color: #888; color: #fff; ">
			                    					...
			                    					<?php foreach($school as $s):?>
			                    						<tr>
								                    		...
								                    		<td style="text-align: right">
								                    			<?php 
								                    			$num1 = getLevelA3School($s->school_id, 'boy', 'spt');
								                    			echo $num1;
								                    		...
								                    		<td style="text-align: right">
								                    			<?php 
								                    			$num2 = getLevelA3School($s->school_id, 'girl', 'spt');
								                    		...
								                    		<td style="text-align: right">
								                    			<?php 
								                    			$num1 = getLevelA3School($s->school_id, 'boy', 'oth');
								                    			echo $num1;
								                    			?>
								                    		</td>
								                    		<td style="text-align: right">
								                    			<?php 
								                    			$num2 = getLevelA3School($s->school_id, 'girl', 'oth');
								                    			echo $num2;
								                    			?>
								                    		</td>
								                    		<td style="text-align: right">
