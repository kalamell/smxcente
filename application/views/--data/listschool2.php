	<div class='container-fluid'>
		<ol class="breadcrumb">
			  ...
			  <li class="active">ตารางแสดงที่ตั้งสถานศึกษา  แยกสังกัด แยกอำเภแ</li>
			</ol>
		...
		<div class="row">
			...
			<div class='col-md-12'>
				<div class="panel panel-default">
				  <div class="panel-heading">ตารางแสดงที่ตั้งสถานศึกษา  แยกสังกัด แยกอำเภแ</div>
			                    				...
			                    				<tr>
					                    			...
					                    			<?php foreach($school_type as $st):?>
							                      		<td width="100" style="text-align: right;">
							                      			<?php 
							                      			$num = countSchoolAreaCode($st->area_code);
							                      			echo $num == 0 ? '&nbsp;' : $num;
							                      			?>
							                      		</td>
							                    	<?php endforeach;?>
