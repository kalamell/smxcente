	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class='col-md-9'>
				...
				<?php echo form_open_multipart('backend/teacher/teacher_update', array('class' => ''));?>
				 ...
				 <div class="form-group col-md-6">
				  ...
				  <div class="form-group col-md-6">
				    ...
				    <div class="radio">
				    	...
				    	<label>
				    		<input type="radio" name="teacher_co" value="ใช่" <?php echo $r->teacher_co == 'ใช่' ? 'checked' : '';?>> ครูผู้ช่วย
				    	</label>
